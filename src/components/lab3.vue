  ...
  export default {
    ...
    props: {
      images: {
        type: Array,
        default: () => [
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmKAf_wNjW4SO_YYhQLJCT3lydmraeKCVbog&s",
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRF-lF0TBJaWT7TtY52d0bCfiyRh7omMGCLFg&s",
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhSxETRkrILV8mmHlqo5rnfN1-UqwuqJxIGw&s"
        ]
      },
      productName: {
        type: String,
